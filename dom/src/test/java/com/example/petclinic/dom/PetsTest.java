...
public class PetsTest {
    ...
    public static class Create extends PetsTest {
        ...
        public void happyCase() throws Exception {
            ...
            // when
            final Pet obj = pets.addPet("Pookie", PetSpecies.CAT, null);

            // then
            assertThat(obj).isEqualTo(pet);
            assertThat(obj.getName()).isEqualTo("Pookie");
            assertThat(obj.getSpecies()).isEqualTo(PetSpecies.CAT);
        }
    ...
    public static class ListAll extends PetsTest {
        ...
        public void happyCase() throws Exception {
            ...
            // when
            final List<Pet> list = pets.allPets();
